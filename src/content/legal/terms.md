...
These terms are an agreement between you and Fisher Bricker ("we", "us"), who operates Backpack
Weight Tracker ("the app"). By creating an account or using the app, you agree to them and to the
[Privacy Policy](https://fisherbricker.github.io/bxpk-legal/privacy). If you do not agree, do not use
the app.
...
We give you a personal, non-exclusive, non-transferable, revocable licence to use the app on Apple
devices you own or control, as permitted by the Apple Media Services Terms and Conditions. You may
not copy, modify, resell, or reverse engineer it.

## Your content

What you post stays yours. By posting it, you give us a worldwide, non-exclusive, royalty-free
licence to store, copy, display and distribute it, only as needed to run the app and show it to the
...
- Harassment, threats, hate speech, or targeting a person or group
...
We remove content that breaks these rules and suspend accounts that do it repeatedly or seriously.
Serious cases are removed immediately and permanently.

## Reporting and blocking

Every post and comment can be reported. Reporting is not a unilateral delete button: enough reports
takes content down from view immediately, but it is then reviewed by a person, usually within 24
...
We may change, pause or stop any part of the app. We do not promise it is always available or that
your data is never lost. Keep your own record of anything you cannot afford to lose.

## Ending things

You can delete your account at any time from Settings. We can suspend or end an account that breaks
these terms, puts other people at risk, or where the law requires it. The sections on your content,
estimates, disclaimers, liability and disputes continue after an account ends.

## Disclaimers

The app is provided "as is" and "as available", without warranties of any kind, whether express or
implied, including warranties of merchantability, fitness for a particular purpose, accuracy and
non-infringement, to the extent the law allows.

## Limitation of liability

To the extent the law allows, we are not liable for any indirect, incidental, special, consequential
or punitive damages, or for loss of data, arising from your use of the app. Our total liability for
any claim relating to the app is limited to the greater of the amount you paid us in the 12 months
before the claim, or US $50. Some places do not allow these limits, so they may not apply to you.

## Indemnity

If someone brings a claim against us because of content you posted or your breach of these terms,
you agree to cover the reasonable costs of that claim, to the extent the law allows.
...
and has no obligation to provide maintenance or support for it. If the app fails to meet any
applicable warranty, you may notify Apple, and Apple will refund the purchase price, if any; to the
extent the law allows, Apple has no other warranty obligation. Apple is not responsible for
addressing any claims relating to the app, including product liability claims, claims that the app
fails to meet legal or regulatory requirements, consumer protection claims, or claims that it
infringes someone's intellectual property; we are. You confirm you are not in a country subject to a
US government embargo and are not on any US government list of prohibited or restricted parties.
Apple and its subsidiaries are third-party beneficiaries of these terms and may enforce them against
you.

## General

If any part of these terms cannot be enforced, the rest still applies. Not enforcing a term is not
a waiver of it. You may not transfer these terms; we may, as part of a sale or transfer of the app.
These terms and the Privacy Policy are the whole agreement between you and us about the app.

## Changes

If these terms change in a way that matters, the app will ask you to accept the new version before
